...
class cAnalisis extends CI_Controller
{
	...
	public function hitung()
	{
		...
		$jumlah_kebutuhan = $this->db->query("SELECT SUM(jumlah) as total, barang.id_barang FROM `barang_keluar` JOIN dbarang_keluar ON barang_keluar.id_bkeluar=dbarang_keluar.id_bkeluar JOIN barang ON barang.id_barang=dbarang_keluar.id_barang WHERE barang.id_barang='" . $barang . "'AND MONTH(tgl_keluar)='" . $bulan . "' AND YEAR(tgl_keluar)='" . $periode . "'")->row();
		//perhitungan EOQ
