		...
		<nav class="mt-2">
			<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
				...
				<li class="nav-item">
					<a href="<?= base_url('Owner/cLaporan') ?>" class="nav-link <?php if ($this->uri->segment(1) == 'Owner' && $this->uri->segment(2) == 'cLaporan') {
																					echo 'active';
																				}  ?>">
				...
				<li class="nav-item">
					<a href="<?= base_url('Owner/cLaporanAnalisis') ?>" class="nav-link <?php if ($this->uri->segment(1) == 'Owner' && $this->uri->segment(2) == 'cLaporanAnalisis') {
																							echo 'active';
																						}  ?>">
